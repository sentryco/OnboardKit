...
struct ControlOverlay: View {
    ...
    * - Description: This property represents the total number of pages in the onboarding flow. 
    ...
    * - Description: This closure is triggered when the previous button is pressed. 
    *                It allows for custom behavior to be defined for navigating backwards in the onboarding flow.
    */
    ...
    *                It allows for custom behavior to be defined for navigating forwards in the onboarding flow.
    */
