 ...
 * - Description: This section of the code previews a single onboarding page in dark mode
 *                for the application. It sets the environment color scheme to dark
 *                and tests the view with a pure black background.
