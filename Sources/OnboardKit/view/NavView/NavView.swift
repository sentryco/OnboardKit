 ...
 * - Description: The `NavView` struct defines a navigation view for the
 *                onboarding process. It includes a total number of pages, the
 *                current page being displayed, and actions for button presses.
 *                It is responsible for managing the navigation between different
 *                onboarding pages.
...
struct NavView: View {
    ...
    * - Description: This property represents the total number of pages in the
    ...
    *                in the navigation view. It is used to track the user's
