...
extension ControlOverlay {
    ...
    */
   internal static let defaultPrevButtonPress: OnPrevButtonPress = { Swift.print("Default prev") } // Default action for previous button press
   /**
    ...
    */
   internal static let defaultOnNextButtonPress: OnNextButtonPress = { Swift.print("Default next") } // Default action for next button press
}
